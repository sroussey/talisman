...
describe('legalipy', function() {
  ...
  describe('training', function() {
    ...
    it('should properly be trained.', function() {
      ...
      sameMembers(Array.from(englishTokenizer.onsets), englishOnsets);
      sameMembers(Array.from(frenchTokenizer.onsets), frenchOnsets);
    });
  });
  ...
  describe('tokenization', function() {
    ...
    it('should properly tokenize.', function() {
      const englishTests: [string, string[]][] = [
      ...
      const frenchTests: [string, string[]][] = [
        ['cheval', ['che', 'val']],
  ...
  describe('import/export', function() {
    it('should be possible to export the onsets.', function() {
      ...
      sameMembers(model.onsets, englishOnsets);
    });
