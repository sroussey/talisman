 ...
 * @param index - Index of the character to substitute.
 * @param char - The replacing character.
 * @return The resulting string.
 */
function replaceAt(string: string, index: number, char: string): string {
 ...
 * @return The resulting string.
 */
function deleteAt(string: string, index: number): string {
 ...
 * @param suffix - The considered suffix.
 */
function endsWith(string: string, length: number, suffix: string): boolean {
 ...
 */
export function minimal(word: string): string {
  if (word.length < 6)
    return word;
 ...
 * @return The resulting stem.
 */
function normalize(stem: string, length: number): string {
  if (length > 4) {
