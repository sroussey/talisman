 ...
 */
/**
 * The variants of the algorithm this module implements.
 */
export type NysiisVariant = 'original' | 'refined';

/**
 * The substitutions applied by a given variant.
 */
interface NysiisPatterns {
  readonly first: [RegExp, string][];
  readonly second: [RegExp, string][];
}

const PATTERNS: Record<NysiisVariant, NysiisPatterns> = {
  original: {
    first: [
      [/JR$/g, ''],
      [/SR$/g, ''],
 ...
 */
function nysiis(type: NysiisVariant, name: string): string {
