 ...
 */
/**
 * A letter's encoding: either a code or a list of contextual substitutions.
 */
type RogerRootEncoding = Record<string, string | [string, string][]>;

const FIRST_LETTER_ENCODING: RogerRootEncoding = {
  A: '1',
  B: '09',
  C: [
    ['CE', '00'],
...
const ENCODING: RogerRootEncoding = {
  B: '9',
  C: [
    ['CE', '0'],
    ['CH', '6'],
 ...
 * @return The roger root code.
 *
 * @throws {Error} The function expects the name to be a string.
 */
export default function rogerRoot(name: string): string {
