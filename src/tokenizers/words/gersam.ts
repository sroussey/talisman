...
const LATIN_CONTRACTIONS: [RegExp, string][] = [
  [new RegExp(`([^${LETTER}])(['’])([^${LETTER}])`, 'g'), '$1 $2 $3'],
  [new RegExp(`([^${LETTER}])(['’])([${LETTER}])`, 'g'), '$1 $2 $3'],
  [new RegExp(`([${LETTER}])(['’])([^${LETTER}])`, 'g'), '$1 $2 $3'],
  [new RegExp(`([${LETTER}])(['’])([${LETTER}])`, 'g'), '$1$2 $3']
...
const SOMALIAN_CONTRACTIONS: [RegExp, string][] = [
  [new RegExp(`([^${LETTER}])(['’])([^${LETTER}])`, 'g'), '$1 $2 $3'],
  [new RegExp(`([^${LETTER}])(['’])([${LETTER}])`, 'g'), '$1 $2 $3'],
  [new RegExp(`([${LETTER}])(['’])([^${LETTER}])`, 'g'), '$1 $2 $3'],
];
...
const FRENCH_EXCEPTIONS: [RegExp, string][] = [
 ...
 *
 * @param lang - Target language in ISO 639-1 format.
 * @param text - The text to tokenize.
 * @return The tokens.
 */
export default function tokenize(lang: string, text: string): string[] {
