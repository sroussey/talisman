...
/**
 * A node of the pattern tree: the hyphenation points known for the path
 * leading to it, along with its children, keyed by character.
 */
interface PatternNode {
  points?: number[];
  [character: string]: PatternNode | number[] | undefined;
}
 ...
 * @return The word's parts.
 */
export default function liang(word: string): string[] {
