 ...
 * @return The Damerau-Levenshtein distance between a & b.
 */
export default function damerauLevenshtein<T>(a: Sequence<T>, b: Sequence<T>): number {
  if (a === b)
    return 0;
 ...
 * @param a - The first sequence to process.
 * @param b - The second sequence to process.
 * @return The Damerau-Levenshtein distance between a & b or Infinity.
 */
