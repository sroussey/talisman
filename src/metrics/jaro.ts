 ...
 * @return The Jaro score between a & b.
 */
export default function jaro<T>(a: Sequence<T>, b: Sequence<T>): number {
 ...
 */
const distance = <T>(a: Sequence<T>, b: Sequence<T>): number => 1 - jaro(a, b);
